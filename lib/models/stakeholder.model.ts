...
export const Stakeholder =
	models.Stakeholder || model<IStakeholder>('Stakeholder', stakeholderSchema);
export const StakeholderImport =
	models.StakeholderImport ||
	model<IStakeholderImport>('StakeholderImport', stakeholderImportSchema);
