  ...
  return (
    <div className="lg:hidden">
      <Sheet>
        ...
        <SheetContent
          side={"left"}
          className="w-80 bg-white/95 backdrop-blur-md dark:bg-gray-900/95 border-r border-gray-200/20 dark:border-gray-700/20"
        >
            ...
            {sidebarLinks.map((link) => {
              ...
              return (
                <SheetClose asChild key={link.label}>
                  <Link
                    href={link.path}
                    className={`flex items-center gap-4 px-4 py-3 mx-2 rounded-xl font-medium text-base transition-all duration-200 hover:scale-105 ${
                      active
