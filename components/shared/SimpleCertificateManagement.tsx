...
const ROLES = [
  { id: 'participant', name: 'Participant', icon: <Award className="h-5 w-5" /> },
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleTemplateChange(role.id, value)}
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <div className="border rounded-lg overflow-hidden bg-white relative" style={{ height: '300px' }}>
                  {previewHtml[role.id] ? (
                    <>
                      <iframe
                      ...
                      <div
                        ...
                        dangerouslySetInnerHTML={{ __html: previewHtml[role.id] }}
              ...
              <div className="space-y-2">
                <Button
                  ...
                  disabled={isGenerating[role.id] || getRoleCount(role.id) === 0}
                  className="w-full"
                  size="sm"
                >
                ...
                <Button
                  ...
                  disabled={isDistributing[role.id] || getRoleCount(role.id) === 0}
                  variant="outline"
                  className="w-full"
                  size="sm"
                >
