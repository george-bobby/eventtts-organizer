      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">
            These questions will be automatically included in your feedback
            form. You can customize the text and make them optional.
          </p>
        </div>
        <Button
          variant="outline"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleRequiredToggle(question.id, checked)
                    }
                  />
                </div>
              </div>
                ...
                {question.type === "nps" && (
                  <div className="flex gap-1">
                    {[...Array(10)].map((_, i) => (
                      <div
                        key={i}
                        className="w-8 h-8 border rounded text-center text-sm flex items-center justify-center"
                      >
                        {i + 1}
                      </div>
                    ))}
