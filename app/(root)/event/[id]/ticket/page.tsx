            ...
            <CardDescription>
              ...
              {isRegistered && (
                <div className="mt-2 text-sm text-orange-600">
                  You are registered for this event, but tickets may still be
                  generating. Please try again in a few moments.
                </div>
              )}
            </CardDescription>
          </CardHeader>
    ...
    <div className="min-h-screen bg-background pt-16">
      ...
      <section className="bg-gradient-to-r from-red-600 to-rose-600 py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-red-100 mt-2">{event.title}</p>
        </div>
      </section>
          ...
          <Card className="border-green-200 bg-green-50 mb-8">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-green-700 text-lg">
                Your ticket{tickets.length > 1 ? "s have" : " has"} been
                confirmed and {tickets.length > 1 ? "are" : "is"} ready to use.
              </CardDescription>
            </CardHeader>
            <CardContent className="text-center space-y-4">
        ...
        <div className="space-y-6">
          ...
          {tickets.map((ticket: ITicket, index: number) => (
            <Card
              ...
              className="overflow-hidden shadow-lg border-2 border-red-100 hover:border-red-300 transition-all"
            >
              ...
              <CardContent className="pt-6">
                ...
                <div className="bg-card border-4 border-dashed border-red-400 rounded-xl p-6 mb-6">
                  <p className="text-sm font-semibold text-red-600 mb-4 uppercase tracking-wide text-center">
                    Entry Code
                  </p>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                    ...
                    <div className="md:hidden w-24 h-px bg-border"></div>
                ...
                <div className="space-y-3">
                  ...
                  {ticket.verifiedAt && (
                    <div className="flex justify-between items-center py-2 bg-muted/40 px-3 rounded-lg">
                  ...
                  {ticket.expiresAt && (
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span
                        className={`font-medium ${new Date() > new Date(ticket.expiresAt) ? "text-red-600" : "text-foreground"}`}
                      >
          ...
          <CardContent>
            <ul className="space-y-2 text-sm text-yellow-900">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Please save this page or take a screenshot of your ticket
                  {tickets.length > 1 ? "s" : ""}
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-yellow-600 mt-0.5">•</span>
                <span>
                  You can use either the QR code or entry code for verification
